...
The process of reading with the `Tale\Reader` involves **peeking** and **consuming**.
...
This was just a small example, Tale Reader is made for loop-parsing.
...
Digging deeper, Tale Reader is actually able to lex source code and text of any kind.
